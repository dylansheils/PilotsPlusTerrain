...
Result demo(double q0[3], double q1[3], double min_radius, double interval)
{
	// At the start of demo function
	if (q0 == NULL || q1 == NULL) {
    	fprintf(stderr, "Error: Null pointer received in demo function.\n");
    	exit(EXIT_FAILURE);
	}
